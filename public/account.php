...
<body>
	...
	<div class="account-form container">	
		...
		<form method="POST">
		    ...
		    <textarea type="text" class="form-control form1" placeholder="<?=$user->first_name?>"aria-describedby="basic-addon1"></textarea>
		    <h3 class="sign-placeholders">Last Name</h3>
		    <textarea type="text" class="form-control form1" placeholder="<?=$user->last_name?>"aria-describedby="basic-addon1"></textarea>
		    <h3 class="sign-placeholders">Email</h3>
		    <textarea type="email" class="form-control form1" placeholder="<?=$user->email?>"aria-describedby="basic-addon1"></textarea>
		    <h3 class="sign-placeholders">Password</h3>
		    <textarea type="password" class="form-control form1" placeholder="<?=$user->password?>"aria-describedby="basic-addon1"></textarea>
